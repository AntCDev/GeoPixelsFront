...
![GeoPixels preview](https://geopixels.net/ico/geopreview.png)
...
|---|---|---|
| Production | https://geopixels.net | Live site, stable |
| Development | https://dev.geopixels.net | Staging — merged changes land here first |

## Contributing

Feel free to fork, poke around, or build extensions on top of the frontend. If you'd like to contribute changes back:
...
Questions, issues, or anything else: geopixels@geopixels.net
